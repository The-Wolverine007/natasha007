...
async def start(client, message):
    if message.chat.type in ['group', 'supergroup']:
        buttons = [
            [
                InlineKeyboardButton('⭕️ Status Channel ⭕️', url='https://t.me/TG_Media_Works')
            ],
            [
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('⭕️ Updates', url='https://t.me/TG_Media_Works'),
            InlineKeyboardButton('Movie Town ⭕️', url='https://t.me/+y53tWFUw6Q43NzE9')
            ],[
    ...
    if len(message.command) == 2 and message.command[1] in ["subscribe", "error", "okay", "help"]:
        buttons = [[
            ...
            InlineKeyboardButton('⭕️ Please Click', url='https://t.me/josprojects'),
            InlineKeyboardButton('Movie Town ⭕️', url='https://t.me/+y53tWFUw6Q43NzE9')
            ],[
            InlineKeyboardButton('❌ Close the Menu ❌', callback_data='close_data')
        ]]
